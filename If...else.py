...
1. Determine the grades of students based on their final examination scores and indicate whether the students can proceed to the next semester, 
...
if score < 0 or score > 100:
    ...
    print("Congratulations", name,", you have gotten an A in your finals!")
    if score <= 100 and score >= 91:
        ...
        print("Your fee for the next semester is", total_fee1,"$")
        ...
        print("Your fee for the next semester is", total_fee2,"$")
    else:
        ...
        print("Your fee for the next semester is", total_fee3,"$")
        
elif score <= 69 and score >= 60:
    print("Congratulations", name,", you have gotten a B in your finals!")
    if score <= 69 and score >= 65:
        ...
        print("Your fee for the next semester is", total_fee4,"$")
    else:
        ...
        print("Your fee for the next semester is", total_fee5,"$")
        
elif score <= 59 and score >= 50:
    print(name,", you have gotten a C in your finals.")
    print("Your fee for the next semester is", fee,"$")
    
elif score <= 49 and score >= 40:
    print(name,", you have gotten a D in your finals.")
    print("Your fee for the next semester is", fee,"$")
    
else:
    print(name,", you have failed your finals.")
